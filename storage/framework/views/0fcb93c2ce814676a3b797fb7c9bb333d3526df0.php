...
<?php endif; ?>
							...
							<?php echo method_field('put'); ?>
								<!-- Name -->
								<input type="number" class="d-none" name="id" value="<?php echo e($merchandise->id); ?>">
...
</div><?php /**PATH /home/pandu/Projek/market-place/blog/resources/views/pages/editmerchandise.blade.php ENDPATH**/ ?>