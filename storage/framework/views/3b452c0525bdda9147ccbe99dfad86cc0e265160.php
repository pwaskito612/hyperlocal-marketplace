				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							...
							<?php else: ?>
							<li >
								<a href="<?php echo e(url('/unconfirmed-order')); ?>"><i class="fa fa-bolt"></i> Unconfirmed orders</a>
							</li>
							<?php endif; ?>
						</ul>
					</div>
...
<?php endif; ?>					
						...
						<tbody>
							...
							<tr>
								...
								<td class="action" data-title="Action">
                                    ...
                                    <input type="number" name="id" value="<?php echo e($m->id); ?>" class="d-none">
	...
	<!-- Container End -->
</section><?php /**PATH /home/pandu/Projek/market-place/blog/resources/views/pages/Order/unconfirmedorder.blade.php ENDPATH**/ ?>