		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					...
					with the COD payment system</p>
					<div class="short-popular-category-list text-center">
						<h2>Popular Category</h2>
						<ul class="list-inline">
							<li class="list-inline-item">
								<a href="#"><i class="fa fa-mobile"></i> Mobile</a></li>
							<li class="list-inline-item">
							...
							<li class="list-inline-item">
								<a href="#"><i class="fa fa-heart"></i> Health</a>
							</li>
							<li class="list-inline-item">
								<a href="#"><i class="fa fa-coffee"></i> Furnishings</a>
							</li>
						</ul>
					</div>
...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    ...
		    <p class="card-text">Lorem ipsum dolor sit jamet, consectetur adipisicing elit. Explicabo, aliquam!</p>
...
</section><?php /**PATH /home/pandu/Projek/market-place/blog/resources/views/pages/Home/home.blade.php ENDPATH**/ ?>